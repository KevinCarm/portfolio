...
const Contact = () => {
            ...
            if (validateEmail(emailRef.current.value)) {
                emailjs.sendForm('service_4eqp0py', 'template_5ulqaoc', form.current, 'FaePa9gFHMslQCvfH')
                    .then(() => {
                        ...
                        setIsSending(false)
                        setMessageNotificacion({
                            message: `Hubo un error al enviar tu mensaje, intentalo de nuevo más tarde`,
                            style: "notification is-danger"
                        })
                        setShowNotification(true);
                    });
    ...
    return <>
        ...
        {!showNotification ? null :
            <Notification closeNotification={closeNotificationClickEvent} message={messageNotificacion}/>}
                ...
                <div className={style.container_form}>
                    ...
                    <div className="field">
                        <div className="control">
                            <input name="user_name" ref={userNameRef} className={userNameStyle} type="text"
                                   placeholder="Tu nombre"/>
                        </div>
                    </div>
                    <div className="field">
                        <div className="control">
                            <input name="user_email" ref={emailRef} className={emailStyle} type="email"
                                   placeholder="Tu email"/>
                        </div>
                    </div>
                    <div className="field">
                        <div className="control">
                            <textarea className={messageStyle} ref={messageRef} name="message" id="" cols="20" rows="10"
